...
- **Watch together**: AetherStream casts video, including YouTube, onto an in-world screen and keeps playback synced for anyone watching along, who can see the queue and suggest what plays next. It fetches the two components it needs on first open, showing the download size and progress, so there is nothing to install by hand.
