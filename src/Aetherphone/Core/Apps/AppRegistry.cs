...
internal static class AppRegistry
{
        ...
        AetherStreamQueue videoQueue, WatchAlongSession watchAlong, AetherStreamScreenWindow screenWindow)
    {
        ...
        {
            new LinkpearlApp(services.Messages, services.Linkshells, services.LinkshellMutes, services.LinkpearlNotificationGate, services.LinkpearlLauncher, services.Lodestone, services.Notifications, services.GameData, services.Lookup, services.Confirm, services.ChatLog, services.ChatSend),
        ...
        apps.Add(new Aetherphone.Apps.Coin.CoinApp(services.AethernetSession, services.Coins, services.CoinCatalog,
            services.Confirm, services.BadgeCatalog, services.RemoteImages, services.Casino, services.FrameCatalog,
