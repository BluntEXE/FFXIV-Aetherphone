...
internal static class AppRegistry
{
    public static AppBundle BuildDefault(PhoneServices services)
    {
        ...
        apps.Add(new YellowPagesApp(services.YellowPages, services.YellowPagesLauncher, services.SocialNotifications, services.GramDmLauncher, new AethernetApi(services.Http, services.AethernetSession, "yellowpages"), services.GameData, services.RemoteImages, services.Lodestone, photoLibrary, services.WallpaperImages, services.Configuration, services.Confirm, services.Report));
