...
internal static class ThemeCatalog
{
    ...
    private static readonly PhoneCase[] BuiltInCases =
    {
        ...
        PhoneCase.Art("CosmicEX", PhoneCaseCategory.ArtistSeries, new Vector4(0.141f, 0.141f, 0.172f, 1f), "Rania"),
        PhoneCase.Art("Caduceus", PhoneCaseCategory.ArtistSeries, new Vector4(0.414f, 0.398f, 0.209f, 1f), "Rania"),
