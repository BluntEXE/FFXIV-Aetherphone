...
internal static class L
{
    ...
    internal static class Account
    {
        ...
        public static readonly LocString PatreonLink = new("account.patreonLink", "Link Patreon account");
        public static readonly LocString PatreonLinkSummary = new("account.patreonLinkSummary", "Get the Patreon member badge");
        public static readonly LocString PatreonHint = new("account.patreonHint", "Back Aetherphone on Patreon and link your account to wear the Patreon member badge. The badge follows your membership automatically.");
        ...
        public static readonly LocString PatreonInactiveHint = new("account.patreonInactiveHint", "Your Patreon account is linked, but there's no active paid membership right now. The badge appears as soon as your membership is active.");
        ...
        public static readonly LocString PatreonUnlinkBody = new("account.patreonUnlinkBody", "This disconnects your Patreon account and removes the Patreon member badge. You can link again any time.");
        public static readonly LocString PatreonLinkedTitle = new("account.patreonLinkedTitle", "Patreon linked");
        public static readonly LocString PatreonLinkedBody = new("account.patreonLinkedBody", "Your Patreon account is now connected. The Patreon member badge follows your membership automatically.");
