...
internal static class L
{
    ...
    internal static class Encryption
    {
        ...
        public static readonly LocString HelpOlderKeyBody = new("encryption.helpOlderKeyBody", "Those messages were written before your key changed. Open Older chats below and enter the recovery code you had at that time. Each code only opens the key it was made for, so try the older ones too.");
