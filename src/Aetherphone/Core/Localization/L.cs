    ...
    internal static class Changelog
    {
        public static readonly LocString[] Release0998 =
        {
            ...
            new("changelog.r0998.1",
                "Added Community Radio to Music: a directory of stations players broadcast themselves, each with its own page, host, and links"),
            new("changelog.r0998.2",
                "Station owners get a My Station page where they set the name, description, artwork, tags, and links, and copy the four fields their broadcasting software needs"),
            new("changelog.r0998.3",
                "You can follow a station, and a notification tells you when it goes live and takes you straight to it"),
            new("changelog.r0998.4",
                "A station owner can set a weekly broadcast slot, so a station that is off air now says when it plays next"),
            new("changelog.r0998.5",
                "Station tags filter the Community Radio directory, and community stations also show up in Music search"),
            new("changelog.r0998.6",
                "A station page lists what it played recently, and tapping a track searches for it"),
            new("changelog.r0998.7",
                "Music now plays AAC stations as well as MP3, using the decoder Windows already ships"),
            new("changelog.r0998.8",
                "Every station now names the track it is actually playing, in the directory, on its page, and on the mini player"),
            new("changelog.r0998.9",
                "A community station whose broadcast drops out now reconnects for about a minute instead of ending the stream for everyone listening"),
            new("changelog.r0998.10",
                "Added twenty five new phone cases: seven plain colors and eighteen gradients named after cities and Arcadion bosses"),
            new("changelog.r0998.11",
                "Fat Cat, Cosmic EX, Caduceus, and Magical Girl join the hand-painted art cases"),
            new("changelog.r0998.12",
                "Silkie is replaced with a refined redraw"),
            new("changelog.r0998.13",
                "The new case artwork was made by Silkie, Zivyl, Remi, and Rania"),
            new("changelog.r0998.14",
                "Community badges now come from the Aethernet catalog, so a new badge can appear without waiting for a plugin update"),
            new("changelog.r0998.15",
                "Community badges are drawn everywhere a name appears: feeds, comments, chats, stories, Velvet, musters, Yellow Pages, radio stations, and Activity"),
            new("changelog.r0998.16",
                "Badge names are translated into your language, and follow a language change straight away"),
            new("changelog.r0998.17",
                "Settings lists every badge you hold in a single section, with a toggle that hides any of them"),
            new("changelog.r0998.18",
                "A notification now tells you when a badge is taken away"),
