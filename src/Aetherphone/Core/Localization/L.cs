...
internal static class L
{
    ...
    internal static class Casino
    {
        ...
        public static readonly LocString ChipsRow = new("casino.chipsRow", "Chips in play");
        public static readonly LocString ChipsAt = new("casino.chipsAt", "{0} chips at {1}");
        public static readonly LocString BuyIn = new("casino.buyIn", "Buy in");
        public static readonly LocString TopUp = new("casino.topUp", "Top up");
        public static readonly LocString BuyInFor = new("casino.buyInFor", "Buy in for {0}");
        ...
        public static readonly LocString PickGame = new("casino.pickGame", "Pick a game");
        ...
        public static readonly LocString BuyInConfirmTitle = new("casino.buyInConfirmTitle", "Buy in for {0}?");
        public static readonly LocString BuyInConfirmBody = new("casino.buyInConfirmBody", "{0} coins become chips at the {1} table. Cash out any time to bring them home.");
        public static readonly LocString TopUpConfirmTitle = new("casino.topUpConfirmTitle", "Top up for {0}?");
        public static readonly LocString TopUpConfirmBody = new("casino.topUpConfirmBody", "{0} more coins join your chips on the table.");
        public static readonly LocString CashOutConfirmTitle = new("casino.cashOutConfirmTitle", "Cash out {0}?");
        public static readonly LocString CashOutConfirmBody = new("casino.cashOutConfirmBody", "Your chips leave the table and land in your wallet.");
        ...
        public static readonly LocString BingoBuyMoreFor = new("casino.bingo.buyMoreFor", "Add {0} for {1}");
        public static readonly LocString BingoCardPrice = new("casino.bingo.cardPrice", "{0} a card, up to {1} a room");
        public static readonly LocString BingoHoldingFull = new("casino.bingo.holdingFull", "You hold all {0} cards for this room");
