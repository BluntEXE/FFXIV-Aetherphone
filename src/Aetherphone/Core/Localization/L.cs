    ...
    internal static class Changelog
    {
        public static readonly LocString[] Release1010 =
        {
            ...
            new("changelog.r1010.6",
                "Added Skyfall to Games: tap the sky and an interceptor flies to that spot and blooms into a blast that sweeps every meteor inside it, with six settlements to defend, 28 shots a wave, meteors that split from wave three, and a run that ends only when the last settlement falls"),
            new("changelog.r1010.7",
                "Added Invaders to Games: a rank of invaders marches sideways and drops a step at each edge, four bunkers erode under fire and rebuild every wave, your cannon fires one shot at a time, the rank speeds up as it thins, and a saucer crosses the top now and then for 300"),
            new("changelog.r1010.8",
                "Added CapMan to Games: eat every dot in the maze without being caught, turn the tables on the ghosts for a few seconds with a power pellet, and slip through the tunnel on the middle row, while four ghosts with habits of their own chase, ambush, wander, or guard a corner, faster on every level"),
            new("changelog.r1010.9",
                "Added Hop to Games: hop a critter across five lanes of traffic and five lanes of drifting pads to bank it in one of five dens on the far bank, fill all five to clear the level, and beat a 45 second timer on every trip while the lanes speed up level by level"),
            new("changelog.r1010.10",
                "Added Squadron to Games: three kinds of ship fly in to a formation that breathes in place and peel off in dive runs that shoot as they pass, a diving ship can snatch your fighter with a tractor beam, shooting that captor later brings it back to dock alongside as a dual fighter with a third shot, and every third stage is a challenge worth a thousand for a perfect sweep"),
            new("changelog.r1010.15",
                "Added Doom to Games: the real engine runs on the phone, which turns to landscape and fills the screen with the 4:3 picture, sound effects and MIDI soundtrack included; play is on the keyboard, WASD to move, a drag on the picture or the arrows to turn, Space to fire, E to use, 1 to 7 for weapons and Esc for Doom's own menu, with a key guide shown for the first seconds of each run; losing phone focus pauses and mutes it"),
            new("changelog.r1010.16",
                "Added Word Run to Games: six guesses at a five-letter word, and solving it deals the next at once until a word beats you; a solve pays 500 down to 100 by guesses used plus a speed bonus inside twenty seconds, the on-screen keyboard remembers what each letter has been shown to be, physical keys work too, and word banks in English, German, Spanish, French and Portuguese, each joined by five-letter mount, minion, action and emote names from the game, are picked by a strip that starts on your phone language"),
