    ...
    internal static class Changelog
    {
        public static readonly LocString[] Release1010 =
        {
            ...
            new("changelog.r1010.15",
                "Added Doom to Games: the real engine runs on the phone, drawn 4:3 with sound effects and the MIDI soundtrack, steered with WASD to move, a drag on the screen or the arrows to turn, Space to fire, E to use and 1 to 7 for weapons, or the on-screen pad; losing phone focus pauses and mutes it, and quitting from Doom's own menu returns to the title screen"),
            new("changelog.r1010.16",
                "Doom ships no game data: on first open a setup card fetches the shareware episode, Knee-Deep in the Dead, and optionally a soundfont for the music, checks both against known checksums and keeps them in your Aetherphone folder, where a full DOOM.WAD or DOOM2.WAD is picked up automatically instead"),
