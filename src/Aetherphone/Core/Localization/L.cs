    ...
    internal static class Changelog
    {
        public static readonly LocString[] Release1000 =
        {
            ...
            new("changelog.r1000.45",
                "MogCast holds watch parties: open a room, approve who asks in, and everyone lands on the same moment with the host's queue as Up Next, and anyone hosting in your zone shows up on the Join screen unless they choose to stay unlisted"),
            new("changelog.r1000.46",
                "Rebuilt Linkpearl around conversations: it now captures every game text channel, from say, shout and yell to party, alliance, free company, novice network and all sixteen linkshells, and a person you tell and a tab you built sit as one row in one list sorted by what is talking"),
            new("changelog.r1000.47",
                "Linkpearl tabs are yours to build: pick the channels, name it, give it a tint, then say where replies go, how dense it looks, how long it is kept and what interrupts you, and pin the ones you keep coming back to"),
            new("changelog.r1000.48",
                "Every link the game puts in a chat line is tappable again, with the actions the game itself offers: try on an item, search recipes, open it in Market, open the map at the coordinates, send a tell or an invite, and open a URL"),
            new("changelog.r1000.49",
                "Linkpearl keeps history per conversation and lets you search it, from the Chats screen or inside a thread, and opening a result lands you on that exact line"),
            new("changelog.r1000.50",
                "Contacts and Find People are now one People tab in Linkpearl, with a single search field and a switch between your friends and everyone"),
            ...
            new("changelog.r1000.64",
                "Fixed a card reading 10 breaking across two lines in the card games"),
