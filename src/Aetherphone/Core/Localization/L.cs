...
internal static class L
{
    ...
    internal static class Changelog
    {
        public static readonly LocString[] Release0990 =
        {
            ...
            new("changelog.r0990.48", "Other players can no longer see your character name or Home World in Chirper, Aethergram, or Velvet; profiles show your region instead, such as NA or EU, reported by SHIGYL"),
