...
internal static class L
{
    ...
    internal static class Catalogs
    {
        ...
        public static readonly LocString CaseFoxtail = new("catalog.case.foxtail", "Foxtail");
        public static readonly LocString CaseFrostnip = new("catalog.case.frostnip", "Frostnip");
        public static readonly LocString CaseNacrelle = new("catalog.case.nacrelle", "Nacrelle");
        public static readonly LocString CaseVerdigry = new("catalog.case.verdigry", "Verdigry");
        public static readonly LocString CaseVoltpup = new("catalog.case.voltpup", "Voltpup");
        public static readonly LocString CaseAetherite = new("catalog.case.aetherite", "Aetherite");
        public static readonly LocString CaseChocorunner = new("catalog.case.chocorunner", "Chocorunner");
        public static readonly LocString CaseGembuncle = new("catalog.case.gembuncle", "Gembuncle");
        public static readonly LocString CaseIronsworn = new("catalog.case.ironsworn", "Ironsworn");
        public static readonly LocString CaseKuponuff = new("catalog.case.kuponuff", "Kuponuff");
        public static readonly LocString CasePrickletot = new("catalog.case.prickletot", "Prickletot");
        public static readonly LocString CaseAmourette = new("catalog.case.amourette", "Amourette");
        public static readonly LocString CaseBarkleigh = new("catalog.case.barkleigh", "Barkleigh");
        public static readonly LocString CaseEmberlash = new("catalog.case.emberlash", "Emberlash");
        public static readonly LocString CaseTidecaller = new("catalog.case.tidecaller", "Tidecaller");
