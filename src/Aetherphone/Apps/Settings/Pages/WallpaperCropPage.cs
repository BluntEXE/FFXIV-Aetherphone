...
internal sealed class WallpaperCropPage : ISettingsPage
{
    ...
    public void Draw(in PhoneContext context, Rect body)
    {
        ...
        var area = new Rect(new Vector2(body.Min.X + 16f * scale, body.Min.Y + 8f * scale),
            new Vector2(body.Max.X - 16f * scale, body.Max.Y - footer));
        ...
        else
        {
            ...
            dl.AddImageRounded(texture.Handle, preview.Min, preview.Max, uv0, uv1, 0xFFFFFFFFu, rounding,
    ...
    private void DrawControls(Rect body, PhoneTheme theme,
