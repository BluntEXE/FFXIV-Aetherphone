...
internal static class AdCard
{
        ...
        PhoneTheme theme, AppSkin ui, long nowUnix)
    {
        ...
        Marquee.DrawLeftAuto(drawList, "yellowpages.card.title." + ad.Id, ad.Title, textLeft, card.Min.Y + pad,
        ...
        Marquee.DrawLeftAuto(drawList, "yellowpages.card.identity." + ad.Id, AdText.Identity(ad), textLeft,
            card.Min.Y + pad + 21f * scale, right - textLeft, TextStyles.Footnote, palette.MutedInk);
