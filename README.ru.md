...
Конфиденциальность и безопасность на первом месте: текстовые сообщения, вложения и голосовые заметки защищены сквозным шифрованием, звонки шифруются при передаче, а публикации и изображения проходят ИИ-модерацию с чёткими правилами по контенту.

## Основные возможности

- **Социальное**: микроблог Chirper, фотолента Aethergram, ChocoChat для личной переписки с голосовыми заметками и групповыми звонками, а также Velvet, необязательное приложение-компаньон 18+.
- **Инструменты**: трекер рыночной доски, каталог площадок и событий, внутриигровая музыка, погода, кошелёк, таймеры и сбросы, фотобиблиотека и камера, а также карманный зал мини-игр, среди более чем 30 приложений.
- **Смотрите вместе**: AetherStream транслирует видео, включая YouTube, на экран прямо в игре и синхронизирует воспроизведение для всех, кто смотрит вместе с вами.
- **Сделайте своим**: акцентные палитры, обои, портреты персонажей из Lodestone, свои рингтоны и масштаб размера текста для доступности.
